    ...
    private List<String> firstanalyzeImage(String base64Image, List<String> categories, String convID, String imageID) {
        ...
        String prompt = String.format(
                """
                        ...
                        규칙:
                        1. 반드시 제공된 음식 목록에서만 선택해주세요
                        2. 이미지에 보이는 각각의 음식종류 개수만큼 가장 적합한 카테고리를 중복없이 찾아주세요
                        3. 음식이 여러 개가 있다면 쉼표(,)로 구분해서 나열해주세요
                        4. 만약 목록에 해당하는 음식이 없다면 '해당없음'이라고 답해주세요
                        5. 반찬이나 소스류를 제외하고 주요 요리 카테고리만 찾아주세요
                        6. 추가 설명 없이 카테고리 이름만 작성해주세요
                        7. 이미지 식별자를 꼭 기억해주세요
    ...
    private List<String> analyzeImage(List<String> categories, int foodCount, String convID, String imageID) {
        ...
        String prompt = String.format(
                """
                        ...
                        규칙:
                        1. 반드시 제공된 음식 목록에서만 선택해주세요
                        2. 이미지에서 식별된 %d개의 음식 당 가장 적합한 카테고리를 중복없이 찾아주세요
                        3. 음식이 여러 개가 있다면 쉼표(,)로 구분해서 나열해주세요
                        4. 만약 목록에 해당하는 음식이 없다면 '해당없음'이라고 답해주세요
                        5. 답변 예시: '김치찌개, 밥, 계란후라이' 또는 '피자' 또는 '해당없음''
                        6. 추가 설명 없이 카테고리 이름만 작성해주세요
                        7. 이미지가 기억나지 않으면 '기억없음'이라고 답해주세요
                        8. 이미지 식별자를 꼭 기억해주세요
                        9. 답변 예시: '김치찌개, 밥, 계란후라이' 또는 '피자' 또는 '해당없음''
